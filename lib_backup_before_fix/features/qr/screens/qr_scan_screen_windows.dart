  ...
  Future<void> _showDesktopNotice(BuildContext context) async {
    await showDialog<void>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text(
          'Live QR scanning is available on Android/iOS. Windows image-based QR decoding is not enabled in this build, so the app will not pretend to decode an image it cannot verify.',
        ),
        actions: [
